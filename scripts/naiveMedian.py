...
class naiveMedianClass():
    ...
    cost=0
    # 排序后,选取中位数的简单算法
    def naiveMedian(self,arr,k):

        self.cost=myQsort(arr,0,len(arr))
        return arr[k]

# # test partition
# for i in range(0,100):
#     arr0=np.random.randint(0,10,30000)
#     # arr0=[10 for i in range(0,3000)]
...
#     if(x>y):
#         print("error")
# print("end-test: partition")


# # test qsort correctness
# for i in range(0,10):
#     # arr0=np.random.randint(0,100000,300)
#     arr0=[1000 for i in range(0,1000)]
#     n=myQsort(arr0,0,len(arr0))
...
#             break
#         last=arr0[j]
# print("end-test: qsort correctness")
