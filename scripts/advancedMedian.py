...
class advancedMedianClass():
    ...
    # 基于五数取中的第k顺序值计算算法
    # k在[0,len(arr))范围内
    def advancedMedian_QueueImpl(self,arr,k_in):
...
#     mid1=m1.advancedMedian_QueueImpl(arr,int(len(arr)/2))

#     m2=naiveMedianClass()
#     mid2=m2.naiveMedian(arr1,int(len(arr)/2))


#     if(mid1!=mid2):
#         print("error")
# print("end-test: advancedMedian")  